...
const ProductCard = () => {
  ...
  return (
    <div className='py-3 px-2 bg-white w-[calc((100vw-1rem)/2)] sm:w-[calc((100vw-2rem)/3)] md:w-[calc((100vw-1rem)/3)]  lg:w-[calc((100vw-3.75rem-11rem)/6)] border-[1px] border-gray-300 rounded-lg'>
